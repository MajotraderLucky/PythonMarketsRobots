...
# BID: 1672.64 - 319.344
# ------------------------
# 29-12  eq = 13.15539128
# Equity now = 5.61871276
# My profit = -7.53667852$
# Profit % = -57.289656837937855%
...
while True:
    for i in range(10, 0, -1):
        ...
        profit = float(futBalanceNow) - algorithm.balance02_02_23 - 7.53667852
        profitPercent = (profit / algorithm.balance02_02_23) * 100
        ...
        setupForLong = upTrand == True and downTrand == False and start2max > 15
        setupForShort = downTrand == True and upTrand == False and start2min > 15
        ...
        print(f"", futBidPrise)
        print(f"------------------------")
        print(f"", algorithm.strBalance02_02_23)
        ...
        conditionRestart = len(
            priceArr) > 500 and floatSizeOpenPositions == 0.0
        if conditionRestart:
            client.futures_cancel_all_open_orders(symbol=symbolEth)
